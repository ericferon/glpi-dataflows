...
CREATE  TABLE `glpi_plugin_dataflows_dataflows` (
  ...
  KEY `plugin_dataflows_srcconnectors_id` (`plugin_dataflows_srcconnectors_id`),
  ...
  KEY `plugin_dataflows_destconnectors_id` (`plugin_dataflows_destconnectors_id`),
