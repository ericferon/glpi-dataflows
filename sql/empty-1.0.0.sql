...
CREATE  TABLE `glpi_plugin_dataflows_dataflows` (
  ...
  `plugin_dataflows_fromwebapplications_id` INT(11) NOT NULL default '0' COMMENT 'from webapplication',
  `plugin_dataflows_towebapplications_id` INT(11) NOT NULL default '0' COMMENT 'to webapplication',
  ...
  KEY `plugin_dataflows_fromwebapplications_id` (`plugin_dataflows_fromwebapplications_id`),
  KEY `plugin_dataflows_towebapplications_id` (`plugin_dataflows_towebapplications_id`),
...
SELECT * FROM glpi_plugin_dataflows_sourceconnectors

-- -----------------------------------------------------
-- View `glpi_plugin_dataflows_fromwebapplications`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `glpi_plugin_dataflows_fromwebapplications`;
CREATE OR REPLACE VIEW `glpi_plugin_dataflows_fromwebapplications` AS
SELECT `id`,`name`, `comment` from `glpi_plugin_webapplications_webapplications`;

-- -----------------------------------------------------
-- View `glpi_plugin_dataflows_towebapplications`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `glpi_plugin_dataflows_towebapplications`;
CREATE OR REPLACE VIEW `glpi_plugin_dataflows_towebapplications` AS
SELECT `id`,`name`, `comment` from `glpi_plugin_webapplications_webapplications`;
