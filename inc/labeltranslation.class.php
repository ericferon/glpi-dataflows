...
class PluginDataflowsLabelTranslation extends CommonDBChild
{
    use Glpi\Features\Clonable;

    public static $rightname = 'plugin_dataflows_configuration';
    public static $itemtype  = 'PluginDataflowsConfigdf'; //parent class
    public static $items_id  = 'items_id'; // parent field in current class table (glpi_plugin_dataflows_labeltranslation)
    ...
    {
        $translation = new PluginDataflowsLabelTranslation();
        $translation->add([
            'items_id' => $item->getID(),
            ...
            echo Html::scriptBlock('
                addTranslation' . $item->getID() . $rand . ' = function() {
                    $("#viewtranslation' . $item->getID() . $rand . '").load(
                        "' . Plugin::getWebDir('dataflows') . '/ajax/viewtranslations.php",
...
//                        'itemtype' => $item::getType(),
    ...
    */
    ...
    public static function getLabelFor(array $item)
    {
        ...
        return __($item['description'], 'dataflows') ?? '';
    }
}
